About kenjutsu-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kenjutsu-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/jakirkham/kenjutsu
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3066&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kenjutsu-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kenjutsu` can be installed with `conda`:
...
```
mamba install kenjutsu
```

It is possible to list all of the versions of `kenjutsu` available on your platform with `conda`:
...
```
mamba search kenjutsu --channel conda-forge
```
...
mamba repoquery search kenjutsu --channel conda-forge

# List packages depending on `kenjutsu`:
mamba repoquery whoneeds kenjutsu --channel conda-forge

# List dependencies of `kenjutsu`:
mamba repoquery depends kenjutsu --channel conda-forge
```
